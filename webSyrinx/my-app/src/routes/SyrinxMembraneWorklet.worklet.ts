...
export const syrinxMembraneGenerator = /* typescript */ `class SyrinxMembraneGenerator extends SingleIOProcessor {
    ...
    setIndependentMembranes(isIndependent : number) : void
    {
        if(this.independentMembranes !== isIndependent)
        {
            this.independentMembranes = isIndependent;
            this.initFunc(); //reinitialize
        }
    }
    ...
    generate(input:any, channel:any, parameters:any) {
        ...
        this.setIndependentMembranes(parameters.independentMembranes);
    ...
    generateTracheobronchial(input:any, channel:any, parameters:any) {
        ...
        if(this.independentMembranes === 1)
        {
