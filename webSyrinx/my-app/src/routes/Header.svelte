...
<!-- 	<div class="corner">
	...
	<directions>
		...
		Parameters of the model were adjusted based on Corythosaurus skeleton and skull measurements, as well as for some speculative properties of its syrinx based on other bird and alligator models. The resonance of the trachea is modeled via waveguide synthesis, and the returning pressure waves are fed back into the model. Skull resonance is not accounted for in this model, as it was developed for the musical dinosaur skull instrument, and in that case, the process happens via the physical recreation of the skull. The muscle tension parameter in this demonstration combines the parameters for two types of muscle tension that are implemented in the model: (1) the transmural pressure difference (the pressure difference between inside and outside the syrinx) and (2) the stress exerted by syringeal muscles (the tracheolateralis) as developed in the Zaccarelli, Elemans, et. al. (2006-9) model. The combining of all muscle pressure parameters allows for an easier, more intuitive musical interface. <br /><br />
		
		Note: This dinosaur vocalization demonstration is new in-process prototype and software, and the previous computational model based on Fletcher(1998)/Smyth, et. al. (2004) is still currently installed in the physical musical instrument (June 2024). <br /><br />
	</directions>
