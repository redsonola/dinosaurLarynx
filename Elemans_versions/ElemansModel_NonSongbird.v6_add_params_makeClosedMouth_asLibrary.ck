...
//************************** This worked -- tried to assign the RingDoveSyrinxLTM to a class variable that should act as a pointer (I thought) to 
//to the instantiated Chugen, but time-varying variables did NOT change*******
