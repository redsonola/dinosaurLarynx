...
//they used alligators 31-37cm in length, 0.9 and 1.4kg body mass
    ...
    0.003 * 18 => float a01; //lower rest area
    0.003 * 17 => float a02; //upper rest area, testing a02/a01 = 0.8, testing a convergent syrinx
    ...
    0.04 * 3 => float d1; //1st mass height -- alligator is: d1=0.25, d2=0.05cm -- perhaps this actually doesn't scale up that much? leave alone for now.
    (0.24 - d1)* 3  => float d2; //2nd mass displacement from first
    (0.28 - (d1+d2))* 3  => float d3; //3rd mass displacement from 2nd
