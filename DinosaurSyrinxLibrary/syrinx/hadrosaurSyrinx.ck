...
//NOTE: edited to only have 1 syrinx membrane and going through just the trachea.
...
public class HadrosaurSyrinx extends Chugraph
{
    ...
    WallLossAttenuation wa, waBronchBack, waBronch2Back;
    Gain adder2;
...
function void initGlobals()
{
    ...
    a => wa.a;
    L*2.0 => wa.L; //change for when trachea and brochus are different
...
function void updateInputPressure(float inPG)
{
    float pG1; 
    inPG * 300000 => pG1;
...
function void updateInputMusclePressure(float inTension)
{
...
function void runWithMouse()
{
    ...
    { 
        ...
        float pG1; 
        msg.scaledCursorX * 500000 => pG1;
        //ctrlValue * 250000 => pG1;
        Math.min(pG1, 500000) => pG1;
        mem.changePG(pG1); 
        //mem2.changePG(pG1);
